...
class Ui_AccordMainWindow(object):
    def setupUi(self, AccordMainWindow):
        ...
        self.layout_areaMessageEdit.addWidget(self.buttonSendMessage, 0, 4, 1, 1)
        ...
        self.layout_areaMessageEdit.addWidget(self.stackedMessageEdit, 1, 0, 1, 5)
        ...
        self.layout_areaMessageEdit.addWidget(self.buttonSendImage, 0, 3, 1, 1)
