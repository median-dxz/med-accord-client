...
class Ui_AccordMainWindow(object):
    def setupUi(self, AccordMainWindow):
        ...
        self.layout_areaMessageEdit.addWidget(self.stackedMessageEdit, 1, 0, 1, 6)
        self.buttonSendMessage = QtWidgets.QPushButton(self.areaMessageEdit)
        self.buttonSendMessage.setObjectName("buttonSendMessage")
        self.layout_areaMessageEdit.addWidget(self.buttonSendMessage, 0, 5, 1, 1)
        ...
        self.buttonSendImage = QtWidgets.QPushButton(self.areaMessageEdit)
        self.buttonSendImage.setObjectName("buttonSendImage")
        self.layout_areaMessageEdit.addWidget(self.buttonSendImage, 0, 4, 1, 1)
        ...
        self.buttonSendFile = QtWidgets.QPushButton(self.areaMessageEdit)
        self.buttonSendFile.setObjectName("buttonSendFile")
        self.layout_areaMessageEdit.addWidget(self.buttonSendFile, 0, 3, 1, 1)
    ...
    def retranslateUi(self, AccordMainWindow):
        ...
        self.buttonSendImage.setText(_translate("AccordMainWindow", "发送图片"))
        self.buttonEditMessage.setText(_translate("AccordMainWindow", "编辑"))
        self.buttonSendFile.setText(_translate("AccordMainWindow", "上传文件"))
